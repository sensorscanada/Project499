...
void loop() {
  ...
  while(1){
    ...
    if (millis() - lastConnectionTime > postingInterval) {
      ...
      ThingSpeak.setField(1,String(result_I2C));
      ThingSpeak.setField(2,String(result_Analog));
      ThingSpeak.setField(3,String(I2C_Temp));
      ThingSpeak.setField(4,String(I2C_Light));
